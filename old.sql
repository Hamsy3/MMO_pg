...
ADD COLUMN reg_date DATE DEFAULT(NOW());
...
VALUES ('Elf', 'cool elf', 'really cool elf'),
		('Orc', 'cool orc', 'really cool orc');
INSERT INTO race (fraction_id, full_name, description)
VALUES (1, 'night elf', 'cool night elf'),
		(1, 'forest elf', 'cool forest elf'),
		(1, 'sky elf', 'cool sky elf'),
		(2, 'cave orc', 'cool cave orc'),
		(2, 'desert orc', 'cool desert orc'),
		(2, 'red orc', 'cool red orc');
INSERT INTO combination (profession_id, race_id, fraction_id)
VALUES (1,1,1), (1,2,1), (1,3,1), (1,4,2), (1,5,2), (1,6,2);
...
VALUES /*('elf323', 15, '\image.jpeg', 1000, 1, 1, 1, false, '', 0),
		...
		('elf22', 19, '\image1.jpeg', 1000, 1, 1, 1, false, '', 0),
		('elf1_51', 15, '\image.jpeg', 1000, 1, 51, 1, false, '', 0),
		('elf2_51', 15, '\image.jpeg', 1000, 2, 51, 1, false, '', 0),
		('elf3_51', 15, '\image.jpeg', 1000, 3, 51, 1, false, '', 0),
		('orc1_54', 15, '\image.jpeg', 1000, 4, 54, 1, false, '', 0),
		('orc2_54', 15, '\image.jpeg', 1000, 5, 54, 1, false, '', 0),
		('orc3_54', 15, '\image.jpeg', 1000, 6, 54, 1, false, '', 0),
		('elf1_50', 15, '\image.jpeg', 1000, 2, 50, 1, false, '', 0),
		('orc1_50', 15, '\image.jpeg', 1000, 6, 50, 1, false, '', 0),
		('orc1_51', 16, '\image.jpeg', 1000, 6, 50, 2, false, '', 0)*/
		('orc1_55', 16, '\image.jpeg', 1000, 6, 1, 5, false, '', 0);
INSERT INTO "character" (full_name, lvl, image_path, balance, combination_id, server_id, user_id, block_flag, block_reason, moderator_code) 
VALUES ('elf23', 20, '\image.jpeg', 1000, 1, 1, 1, false, '', 0);
...
VALUES (3, '2024-03-27 15:30:00', '2024-03-27 16:30:00', '\map.jpeg', 0, 4, 5, 10, 7, '10:00:00');
SELECT * FROM "event"

UPDATE team
SET event_id = 41
WHERE team_id IN (58, 56)
...
VALUES (19, 56, 1, 0, 0, 0, 0, false);
SELECT * FROM character_row WHERE (character_id = 19)
/*INSERT INTO character_row (character_id, team_id, character_role_id, dealed_damage, received_damage, healed_damage, killed, death_flag)
...
SELECT '2024-03-31 20:30:38'::timestamp - '2024-03-27 15:30:00'::timestamp;

SELECT team_id, event_id FROM team WHERE event_id IN (SELECT event_id FROM "event") ORDER BY event_id